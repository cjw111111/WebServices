...
public class WeatherWebServiceLocator extends org.apache.axis.client.Service implements Weather.Client.WeatherWebService {
    ...
    public Weather.Client.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Weather.Client.WeatherWebServiceSoap12Stub _stub = new Weather.Client.WeatherWebServiceSoap12Stub(portAddress, this);
    ...
    public Weather.Client.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Weather.Client.WeatherWebServiceSoap_BindingStub _stub = new Weather.Client.WeatherWebServiceSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Weather.Client.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                Weather.Client.WeatherWebServiceSoap12Stub _stub = new Weather.Client.WeatherWebServiceSoap12Stub(new java.net.URL(WeatherWebServiceSoap12_address), this);
                _stub.setPortName(getWeatherWebServiceSoap12WSDDServiceName());
                return _stub;
            }
            if (Weather.Client.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                Weather.Client.WeatherWebServiceSoap_BindingStub _stub = new Weather.Client.WeatherWebServiceSoap_BindingStub(new java.net.URL(WeatherWebServiceSoap_address), this);
                _stub.setPortName(getWeatherWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
